...
#define PFERR_GUEST_ACCESS_ENC_BIT 34
#define PFERR_GUEST_SIZE_MISMATCH_BIT 35
#define PFERR_GUEST_VMPL_PERM_BIT 36
...
#define PFERR_GUEST_ACCESS_ENC_MASK (1ULL << PFERR_GUEST_ACCESS_ENC_BIT)
#define PFERR_GUEST_SIZE_MISMATCH_MASK (1ULL << PFERR_GUEST_SIZE_MISMATCH_BIT)
#define PFERR_GUEST_VMPL_PERM_MASK (1ULL << PFERR_GUEST_VMPL_PERM_BIT)
