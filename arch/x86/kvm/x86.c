...
static int sev_es_outs(struct kvm_vcpu *vcpu, unsigned int size,
...
static int sev_es_ins(struct kvm_vcpu *vcpu, unsigned int size,
		      unsigned int port, void *data, unsigned int count)
{
	int ret;
...
int sev_es_string_io(struct kvm_vcpu *vcpu, unsigned int size,
		     unsigned int port, void *data,  unsigned int count, int in)
{
...
int sev_es_mmio_write(struct kvm_vcpu *vcpu, gpa_t gpa, unsigned int bytes,
		      void *data)
{
	int handled;
	struct kvm_mmio_fragment *frag;
...
EXPORT_SYMBOL_GPL(sev_es_mmio_write);

int sev_es_mmio_read(struct kvm_vcpu *vcpu, gpa_t gpa, unsigned int bytes,
		     void *data)
{
	int handled;
	struct kvm_mmio_fragment *frag;
...
EXPORT_SYMBOL_GPL(sev_es_mmio_read);
